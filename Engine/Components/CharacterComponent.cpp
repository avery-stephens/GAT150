...
namespace gooblegorb
{
	CharacterComponent::~CharacterComponent()
	{
		...
		g_eventManager.Unsubscribe("EVENT_ADD_HEALTH", m_owner);
	}
	...
	void CharacterComponent::Initialize()
	{
		...
		g_eventManager.Subscribe("EVENT_ADD_HEALTH", std::bind(&CharacterComponent::OnNotify, this, std::placeholders::_1), m_owner);
