...
void gooblegorb::SpriteAnimComponent::Update()
{
    //update frame
...
void gooblegorb::SpriteAnimComponent::Draw(Renderer& renderer)
{
    renderer.Draw(m_texture, source, m_owner->m_transform);
}

bool gooblegorb::SpriteAnimComponent::Write(const rapidjson::Value& value) const
{
    return true;
}

bool gooblegorb::SpriteAnimComponent::Read(const rapidjson::Value& value)
{
